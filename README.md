# Solution for Single ALB in AWS EKS fargate for multiple ingress
...
![alt text](https://github.com/rajeshwrn/alb-nginx-controller/blob/master/alb-nginx%20ingress.png?raw=true "alb-architecture")
